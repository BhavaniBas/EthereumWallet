...
public class SharedHelper {
    ...
    public static void putTokenListKey(Context context,  String Key, List<Token> tokenList) {
        sharedPreferences = context.getSharedPreferences(BuildConfig.APPLICATION_ID, Context.MODE_PRIVATE);
        editor = sharedPreferences.edit();
        Gson gson = new Gson();
    ...
    public static List<Token> getTokenListKey(Context context, String Key) {
        sharedPreferences = context.getSharedPreferences(BuildConfig.APPLICATION_ID, Context.MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString(Key, "");
        Type type = new TypeToken<List<Token>>() {}.getType();
        List<Token> arrayList = gson.fromJson(json, type);
        return arrayList;
    }
}
